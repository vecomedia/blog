...
Das hat einen klaren Nachteil wenn es mehrere Nutzer gibt: Es gibt kein Locking, gleichzeitige Schreibvorgänge könnten sich theoretisch überschreiben. Für den aktuellen Einsatzzweck – ein lokales Tool für die eigene Aufgabenliste – ist die JSON File eine Art Provisorium, das sich bei Bedarf später gegen eine Datenbank austauschen lässt.
